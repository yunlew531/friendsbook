...
const Clubs: React.FC = () => {
  return (
    <Wrap>
      <Card>
        <Title>粉絲專頁</Title>
        <Search placeholder="搜尋粉絲專頁" />
      </Card>
      <Card>
        <SubTitle>已追蹤粉絲專頁</SubTitle>
        <ClubList>
          <ClubItem>
            <Link to="/fan/:id">
              ...
              <ClubItemMain>
                <h3 className="title">偶像-布偶貓</h3>
                <span className="members-qty">(10人追蹤)</span>
